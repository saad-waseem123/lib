                ...
                <div class="main-content post-single-content">
                    <div class="post post-grid post-single">
                        <figure class="post-media br-sm">
                            <img src="<?= site_url('uploads/posts/') ?><?= ($formData['post_img']) ? $formData['post_img'] : 'placeholder.png' ?>" alt="Blog" width="930" height="500">
                        </figure>
                        <div class="post-details">
                            <div class="post-meta">
                                ...
                                - <div href="" class="post-date">
                                    <?php
                                    echo date("jS F, Y", strtotime($formData['created_at']));
                                    // outputs 10th December, 2011
                                    ?>
                                </div>
                            </div>
                            <h2 class="post-title"><a href="#"><?= $formData['post_name'] ?></a></h2>
                            <div class="post-content">
                                <p><?= $formData['post_desc'] ?>. </p>
